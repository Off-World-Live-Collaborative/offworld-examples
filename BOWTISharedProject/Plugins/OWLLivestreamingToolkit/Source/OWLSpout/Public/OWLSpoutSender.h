...
{
private:
	FOWLSpoutTools::ERHIType RHIType = FOWLSpoutTools::ERHIType::Null;
...
private:
	...
	bool SetupSendingTextureRHI(UTextureRenderTarget2D* srcRenderTarget, FRHICommandListImmediate& RHICmdList);
	void SetSendingTextureRHIResolution(FIntPoint NewResolution);
};
