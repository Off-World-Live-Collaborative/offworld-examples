...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_UserIndex = { "UserIndex", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOWLSaveGame, UserIndex), METADATA_PARAMS(Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_UserIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_UserIndex_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_PluginUpdateSaveFileName = { "PluginUpdateSaveFileName", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOWLSaveGame, PluginUpdateSaveFileName), METADATA_PARAMS(Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_PluginUpdateSaveFileName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_PluginUpdateSaveFileName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_PluginUpdateSaveGameData = { "PluginUpdateSaveGameData", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOWLSaveGame, PluginUpdateSaveGameData), Z_Construct_UScriptStruct_FPluginUpdateSaveGameData, METADATA_PARAMS(Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_PluginUpdateSaveGameData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_PluginUpdateSaveGameData_MetaData)) }; // 1334579948
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_PluginSettingsSaveFileName = { "PluginSettingsSaveFileName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOWLSaveGame, PluginSettingsSaveFileName), METADATA_PARAMS(Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_PluginSettingsSaveFileName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_PluginSettingsSaveFileName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_PluginSettingsSaveGameData = { "PluginSettingsSaveGameData", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOWLSaveGame, PluginSettingsSaveGameData), Z_Construct_UScriptStruct_FPluginSettingsSaveGameData, METADATA_PARAMS(Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_PluginSettingsSaveGameData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_PluginSettingsSaveGameData_MetaData)) }; // 1883653038
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkit_Private_SaveGameData_OWLSaveGame_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkit_Private_SaveGameData_OWLSaveGame_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOWLSaveGame, UOWLSaveGame::StaticClass, TEXT("UOWLSaveGame"), &Z_Registration_Info_UClass_UOWLSaveGame, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOWLSaveGame), 4000381599U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkit_Private_SaveGameData_OWLSaveGame_h_2110866103(TEXT("/Script/LivestreamingToolkit"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkit_Private_SaveGameData_OWLSaveGame_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkit_Private_SaveGameData_OWLSaveGame_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
