...
template<> LIVESTREAMINGTOOLKIT_API UScriptStruct* StaticStruct<FPluginUpdateSaveGameData>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPluginUpdateSaveGameData_Statics::NewProp_SkipPluginVersion = { "SkipPluginVersion", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FPluginUpdateSaveGameData), &Z_Construct_UScriptStruct_FPluginUpdateSaveGameData_Statics::NewProp_SkipPluginVersion_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FPluginUpdateSaveGameData_Statics::NewProp_SkipPluginVersion_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPluginUpdateSaveGameData_Statics::NewProp_SkipPluginVersion_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPluginUpdateSaveGameData_Statics::NewProp_SkippedPluginVersionHash = { "SkippedPluginVersionHash", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPluginUpdateSaveGameData, SkippedPluginVersionHash), METADATA_PARAMS(Z_Construct_UScriptStruct_FPluginUpdateSaveGameData_Statics::NewProp_SkippedPluginVersionHash_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPluginUpdateSaveGameData_Statics::NewProp_SkippedPluginVersionHash_MetaData)) };
...
template<> LIVESTREAMINGTOOLKIT_API UScriptStruct* StaticStruct<FPluginSettingsSaveGameData>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPluginSettingsSaveGameData_Statics::NewProp_EnableRuntimeViewportRendering = { "EnableRuntimeViewportRendering", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FPluginSettingsSaveGameData), &Z_Construct_UScriptStruct_FPluginSettingsSaveGameData_Statics::NewProp_EnableRuntimeViewportRendering_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FPluginSettingsSaveGameData_Statics::NewProp_EnableRuntimeViewportRendering_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPluginSettingsSaveGameData_Statics::NewProp_EnableRuntimeViewportRendering_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkit_Private_SaveGameData_ServerConfigSaveGameData_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkit_Private_SaveGameData_ServerConfigSaveGameData_h_Statics::ScriptStructInfo[] = {
		{ FPluginUpdateSaveGameData::StaticStruct, Z_Construct_UScriptStruct_FPluginUpdateSaveGameData_Statics::NewStructOps, TEXT("PluginUpdateSaveGameData"), &Z_Registration_Info_UScriptStruct_PluginUpdateSaveGameData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPluginUpdateSaveGameData), 1334579948U) },
		{ FPluginSettingsSaveGameData::StaticStruct, Z_Construct_UScriptStruct_FPluginSettingsSaveGameData_Statics::NewStructOps, TEXT("PluginSettingsSaveGameData"), &Z_Registration_Info_UScriptStruct_PluginSettingsSaveGameData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPluginSettingsSaveGameData), 1883653038U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkit_Private_SaveGameData_ServerConfigSaveGameData_h_4016886751(TEXT("/Script/LivestreamingToolkit"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_HostProject_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkit_Private_SaveGameData_ServerConfigSaveGameData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkit_Private_SaveGameData_ServerConfigSaveGameData_h_Statics::ScriptStructInfo),
		nullptr, 0);
