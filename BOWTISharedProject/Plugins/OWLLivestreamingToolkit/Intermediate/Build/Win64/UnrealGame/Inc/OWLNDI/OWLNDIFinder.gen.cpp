...
template<> OWLNDI_API UScriptStruct* StaticStruct<FNDISource>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FNDISource_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNDISource, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FNDISource_Statics::NewProp_Name_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNDISource_Statics::NewProp_Name_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FNDISource_Statics::NewProp_URL = { "URL", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNDISource, URL), METADATA_PARAMS(Z_Construct_UScriptStruct_FNDISource_Statics::NewProp_URL_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNDISource_Statics::NewProp_URL_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_OWLLivestreamingToolkit_Source_OWLNDI_Public_OWLNDIFinder_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_OWLLivestreamingToolkit_Source_OWLNDI_Public_OWLNDIFinder_h_Statics::ScriptStructInfo[] = {
		{ FNDISource::StaticStruct, Z_Construct_UScriptStruct_FNDISource_Statics::NewStructOps, TEXT("NDISource"), &Z_Registration_Info_UScriptStruct_NDISource, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNDISource), 1779991527U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_OWLLivestreamingToolkit_Source_OWLNDI_Public_OWLNDIFinder_h_130657792(TEXT("/Script/OWLNDI"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_HostProject_Plugins_OWLLivestreamingToolkit_Source_OWLNDI_Public_OWLNDIFinder_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_OWLLivestreamingToolkit_Source_OWLNDI_Public_OWLNDIFinder_h_Statics::ScriptStructInfo),
		nullptr, 0);
